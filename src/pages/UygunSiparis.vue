        ...
        <div class="tbody">
          ...
          >
            <div>
              ...
              >
                {{ ordstatLabel(o) }}
                <div v-if="o.has_box" class="tiny hint">
                  📦 Bu siparişe ait sistemde koli var
                </div>
              </span>
            </div>
...
.w150{ width:150px } .w170{ width:170px } .w220{ width:220px }
...
.st-open{   background:#ecfdf5; border:1px solid #a7f3d0; color:#065f46; }
.st-part{   background:#fef9c3; border:1px solid #fde68a; color:#92400e; }
.st-closed{ background:#fee2e2; border:1px solid #fecaca; color:#991b1b; }
...
.thead, .tr{
  display:grid;
  grid-template-columns: 90px 120px 80px 140px 140px 140px 140px 160px 90px;
...
.w90{ width:90px } .w120{ width:120px } .w140{ width:140px } .w160{ width:160px } .w80{ width:80px }
.right{ text-align:right }
.mono{ font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", monospace }

.row-ok{ background:#f9fffb }
...
.txt-bad{ color:#b91c1c; font-weight:600 }
...
.modal{
  width:min(800px, 96vw); max-height:90vh; overflow:auto;
  background:#fff; border-radius:12px; border:1px solid #e5e7eb;
  padding:12px; box-shadow:0 18px 60px rgba(0,0,0,.28);
}
.modal-head{
